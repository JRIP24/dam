...
public class CustomerOffer1 extends CustomerWithOffer {
    ...
    /**
     * Calculates the bill amount. Users with offer 1 pay the total of minutes by the price per
     * minute minus a discount, but the 3 first minutes are free.
     * 
    ...
    public double billAmount() {
        ...
        double minutes = c.nMinutes();      if (minutes > 3) {          minutes2invoice += minutes - 3;
            }
        }
